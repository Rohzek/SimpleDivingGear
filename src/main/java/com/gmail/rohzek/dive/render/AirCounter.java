				...
				if(chest.getItem() == SArmor.DIVE_CHEST.get().asItem()) 
				{
	            	...
	            	long seconds = (miliseconds / 1000) % 60;
					  ...
					  { 
						  ...
						  event.getGuiGraphics().drawString(mc.font, display, getXCenter(display), getYCenter(display), Integer.parseInt("db8786", 16), false);
					  } 
					  else 
					  { 
						  ...
						  event.getGuiGraphics().drawString(mc.font, display, getXCenter(display), getYCenter(display), Integer.parseInt("ffffff", 16), false);
					  }
				}
