...
{
	public SNetherDiveGear(ArmorMaterial mat, ArmorType equipSlot, String itemname) 
	{
	...
	{
		return ResourceLocation.fromNamespaceAndPath(Reference.MODID, "textures/models/armor/netherdivegear" + (type == LayerType.HUMANOID_LEGGINGS ? "_layer_2" : "_layer_1") + ".png");
	}
